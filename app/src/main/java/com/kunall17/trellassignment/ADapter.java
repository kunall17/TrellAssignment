...
public class ADapter extends RecyclerView.Adapter<Viddd> {
    ...
    public ADapter(Context context) {
        ...
        DefaultHttpDataSourceFactory factory = new DefaultHttpDataSourceFactory("android-marsplay-video-player");
        ...
        ExtractorMediaSource mediaSource = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(a.get(0)));
    ...
    public void setPlayer(int s, @NotNull Viddd holder) {
        ...
        if (lastINdex != s) {
            ExtractorMediaSource mediaSource = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(a.get(s)));
            player.prepare(mediaSource);
            player.seekTo(0);
            lastINdex = s;
